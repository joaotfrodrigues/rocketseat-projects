...
var verify_task_authorization_exports = {};
__export(verify_task_authorization_exports, {
  verifyTaskAuthorization: () => verifyTaskAuthorization
});
module.exports = __toCommonJS(verify_task_authorization_exports);
...
// src/middlewares/verify-task-authorization.ts
async function verifyTaskAuthorization(request, response, next) {
  if (!request.user) {
...
decimal.js/decimal.mjs:
   ...
   *)
*/
//# sourceMappingURL=verify-task-authorization.js.map