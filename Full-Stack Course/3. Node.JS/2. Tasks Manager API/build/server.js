...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    x(z9, "PrismaClientKnownRequestError");
...
`);
    ...
    function qr({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z9(gm(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new j(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function gm(e, r) {
      let t = e.message;
...
`;
    ...
    async function Ft(e, r) {
      ...
      if (n.type === "QueryEngineError") throw new z9(n.body.message, { code: n.body.error_code, clientVersion: r });
    ...
    var Qr = class {
      ...
      async transaction(r, t, n) {
        ...
        if (Tf(a)) {
          ...
          throw l ? l.error : new z9(a.message, { code: a.error_code, clientVersion: this.config.clientVersion, meta: a.meta });
    ...
    var ri = class {
      ...
      handleRequestError({ error: r, clientMethod: t, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        if (n && (l = Pn({ callsite: n, originalMethod: t, isPanic: r.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), l = this.sanitizeMessage(l), r.code) {
          ...
          throw new z9(l, { code: r.code, clientVersion: this.client._clientVersion, meta: u, batchRequestIdx: r.batchRequestIdx });
        } else {
...
var UsersController = class {
  ...
  async create(request, response) {
    const bodySchema = import_zod4.z.object({
      name: import_zod4.z.string().trim().min(2).max(50),
      email: import_zod4.z.email().trim(),
      password: import_zod4.z.string().min(6).max(16)
    });
...
var TeamsController = class {
  ...
  async create(request, response) {
    const bodySchema = import_zod5.z.object({
      name: import_zod5.z.string().min(2).max(50),
...
var TasksController = class {
  ...
  async create(request, response) {
    const bodySchema = import_zod7.z.object({
      title: import_zod7.z.string().min(2).max(50),
      description: import_zod7.z.string().optional(),
      status: import_zod7.z.enum(["pending", "in_progress", "completed"]),
      priority: import_zod7.z.enum(["low", "medium", "high"]),
      assigned_to: import_zod7.z.uuid(),
      team_id: import_zod7.z.uuid()
    });
    const {
      title,
...
var TaskStatusController = class {
  async update(request, response) {
    const bodySchema = import_zod8.z.object({
      status: import_zod8.z.enum(["pending", "in_progress", "completed"])
    });
    const paramsSchema = import_zod8.z.object({
      task_id: import_zod8.z.uuid()
    });
