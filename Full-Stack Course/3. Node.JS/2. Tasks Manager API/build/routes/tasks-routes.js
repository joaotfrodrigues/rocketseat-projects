...
`);
    ...
    function qr({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z4(gm(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new j(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function gm(e, r) {
      let t = e.message;
...
function ensureAuthenticated(request, response, next) {
  try {
    ...
    const { role, sub: userId } = (0, import_jsonwebtoken.verify)(token, authConfig.jwt.secret);
    request.user = {
      id: userId,
      role
    };
